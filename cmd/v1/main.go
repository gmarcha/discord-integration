...
type CommandHandle = func(s *discordgo.Session, i *discordgo.InteractionCreate)
type MapStrCommandHandle = map[string]CommandHandle
...
var (
	...
	commandHandlers MapStrCommandHandle
)
